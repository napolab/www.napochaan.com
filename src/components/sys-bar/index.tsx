...
// Transitional nav targets: 'index', 'about', 'works', 'news', 'log' and 'blog'
// are real pages; 'gallery' still jumps to its home-page section until its own
// route exists (see isNavActive — anchors are never page-active).
const navItems = [
  { label: 'index', href: '/' },
