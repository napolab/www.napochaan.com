...
export const createSoftwareDownloadBlockConverters = ({ softwareDownloads, turnstileSiteKey, issueDownloadURL }: ConverterContext): NonNullable<JSXConverters<NodeTypes>['blocks']> => ({
  'software-download': ({ node }) => {
    ...
    return <SoftwareDownloadGate software={download} turnstileSiteKey={turnstileSiteKey} issueDownloadURL={issueDownloadURL} />;
  },
});
