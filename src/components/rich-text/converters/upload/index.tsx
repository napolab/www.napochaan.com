 ...
 * over the backdrop, rather than upscaling them to the 16:9 frame. Non-image
 * uploads fall back to a download link.
 */
export const uploadConverter: Partial<JSXConverters<NodeTypes>> = {
  upload: ({ node }) => {
    ...
    return <Figure src={url} alt={alt} width={width} height={height} caption={caption} variant="cover" fit="intrinsic" placeholder="blur" blurDataURL={formatBlurURL(url, { blur: 20 })} />;
  },
};
