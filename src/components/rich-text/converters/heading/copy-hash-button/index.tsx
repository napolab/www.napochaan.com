...
export const CopyHashButton = ({ slug, label = 'リンクをコピー', onPress, className }: Props) => {
  ...
  return <Button type="button" aria-label={label} onPress={handlePress} data-copied={copied || undefined} className={clsx(styles.root, className)} />;
};
