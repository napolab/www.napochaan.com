...
export const Image = (props: Props) => {
  ...
  return <NextImage {...props} onLoad={handleLoad} placeholder={isPlaceholderBlur ? 'empty' : props.placeholder} style={isPlaceholderBlur && loading ? placeholderStyle : props.style} />;
};
