...
// segment (`/works/preview/<id>`, `/blog/preview/<id>`); aggregate previews
...
export const PREVIEW_PATH_PREFIXES = ['/news/preview/', '/works/preview/', '/blog/preview/', '/gallery/preview', '/log/preview'] as const;
