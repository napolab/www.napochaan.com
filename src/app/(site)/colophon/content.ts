...
export const colophon = {
  ...
  // NOTE: concept copy is a draft from the design direction — rewrite freely.
  concept: {
    intro: 'このサイトのコンセプト、ひとことで言うと「白の上で、過剰をやる」なんだよなぁ。',
    points: [
      {
        term: '秩序の上に、過剰を盛る。',
        description: '方眼のグリッドで秩序を敷いて、その上に黒のグロテスク・エレクトリックブルー・等幅のシステム文字を過剰に重ねる。白を地にしたデジタルなグラフィックデザインの版面。',
      },
      {
        term: '機械的なUIは、置かない。',
        description: '汎用テンプレートを当てはめた画面は作らない。伝えたい情報ごとに「これは何で、どう伝わるべきか」を問い直して、その答えに固有の UI を与えるんだよなぁ。',
      },
      {
        term: '完成させない。',
        description: 'このサイトは「完成品」じゃなく rebuild され続けるもの。作り直すという行為そのものが、ぼくにとっては考えるための手段なんだよなぁ。',
      },
    ],
  },
  typography: {
