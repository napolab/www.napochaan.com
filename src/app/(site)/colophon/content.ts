...
export const colophon = {
  ...
  concept: {
    ...
    points: [
      ...
      {
        term: 'ターミナルの緑は、選ばなかった。',
        description:
          'webcore やデジタル系が好きで、Y2K はダサいと思ってる。仕事で作る booth2booth のダークホログラフィックは仕事の顔だから、個人サイトはあえて別物にした。緑×黒のターミナルじゃなく、白地・黒タイポ・電撃ブルーでシステム感を出す。そういう選び方をした。',
      },
      {
        term: '機械的なUIは、置かない。',
