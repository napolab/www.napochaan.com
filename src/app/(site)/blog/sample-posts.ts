...
// 2 pages), spanning 2026-05 → 2025-11. Topics fit the owner — a programmer / DJ / VJ who
...
export const posts: readonly Post[] = [
  post({ id: '1', index: '01', title: '静かなインターネットの話', date: '2026-05-20', excerpt: '個人サイトを作り直しながら考える、自分のためのインターネットについて。' }, [
  ...
  post({ id: '2', index: '02', title: 'Panda CSS で作る design token', date: '2026-05-10', excerpt: 'OKLCH と semantic token で WCAG AA を機械的に担保する話。' }, [
  ...
  post({ id: '3', index: '03', title: 'Cloudflare Workers で Next.js を動かす', date: '2026-04-28', excerpt: 'OpenNext と ISR をエッジで両立させるための構成メモ。' }, [
  ...
  post({ id: '4', index: '04', title: 'Hono RPC で型安全な通信を作る', date: '2026-04-15', excerpt: 'サーバとクライアントの間に型の境界を引かないという選択。' }, [
  ...
  post({ id: '5', index: '05', title: 'y-durableobjects で共同編集を実装する', date: '2026-03-30', excerpt: 'Durable Object を権威サーバにした CRDT 同期の設計。' }, [
  ...
  post({ id: '6', index: '06', title: 'VJ セットの設計図', date: '2026-03-12', excerpt: '映像を「曲に合わせる」のではなく「場に合わせる」という発想。' }, [
  ...
  post({ id: '7', index: '07', title: 'AI コーディングと向き合う', date: '2026-02-25', excerpt: '生成されたコードを「読む」技術が、書く技術より重くなった話。' }, [
  ...
  post({ id: '8', index: '08', title: 'Durable Object でリアルタイムカーソル', date: '2026-02-08', excerpt: '訪問者同士のカーソルを共有する小さな実験。' }, [
  ...
  post({ id: '9', index: '09', title: 'グリッドの上で組版する', date: '2026-01-20', excerpt: '白を基調にしたグラフィックデザインの版面づくり。' }, [
  ...
  post({ id: '10', index: '10', title: 'oxlint への移行記', date: '2025-12-15', excerpt: 'ESLint から oxlint へ。速度と引き換えに失ったものと得たもの。' }, [
  ...
  post({ id: '11', index: '11', title: 'tsgo で型検査を速くする', date: '2025-11-28', excerpt: 'TypeScript native preview で typecheck を体感できる速さに。' }, [
