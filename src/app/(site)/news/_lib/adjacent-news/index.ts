...
// Neighbours of `slug` within the full feed ordered newest-first: prev = the newer
// item (previous in the sorted list), next = the older item (next in the sorted
// list). Both are undefined at the ends, and both are undefined when the slug is
