...
// module that imports it — like themes/fonts.ts — throws immediately under
// plain vitest. Keeping this constant in its own next/font-free module lets
// themes/tokens/index.ts (and its node test) read the variable name directly,
// without dragging in next/font.
//
...
// constant cannot be interpolated into that call in fonts.ts — the literal
// there is kept in sync with this constant by hand, and font-vars.test.ts
// statically asserts the two match so a drift fails loudly.
